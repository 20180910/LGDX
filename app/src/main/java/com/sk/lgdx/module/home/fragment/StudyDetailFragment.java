...
public class StudyDetailFragment extends BaseFragment {
    ...
    public static StudyDetailFragment newInstance(String course_type_id) {
        StudyDetailFragment fragment = new StudyDetailFragment();
        Bundle args = new Bundle();
        args.putString(Constant.IParam.course_type_id,course_type_id);
...
//        rv_study_today.addItemDecoration(new DividerGridItemDecoration(mContext,PhoneUtils.dip2px(mContext,12),R.color.white));
    ...
    protected void getData(int page, boolean isLoad) {
        ...
        map.put("course_type_id",getArguments().getString(Constant.IParam.course_type_id));
        map.put("pagesize",pageSize+"");
        map.put("page",page+"");
        map.put("sign", GetSign.getSign(map));
        ApiRequest.getHistoryCourseWareList(map, new MyCallBack<HistoryCourseWareListObj>(mContext,pcfl,pl_load) {
            @Override
