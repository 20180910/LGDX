...
public class MyDataActivity extends BaseActivity {
    ...
    String name,avatar,className,sex,mobile,email;
    ...
    protected void initView() {
        ...
        tv_my_data_banji.setText(className);
        tv_my_data_sex.setText(sex);
        tv_my_data_phone.setText(mobile);
            Glide.with(mContext).load(avatar).error(R.drawable.my_people).into(iv_my_data_icon);
        if (email.equals("")) {
            ...
            public void onMyNext(String baseImg) {
               ...
               ApiRequest.uploadImg(map,body, new MyCallBack<BaseObj>(mContext,true) {
                    ...
                    public void onSuccess(BaseObj obj) {
                        imgUrl = obj.getImg();
                        Glide.with(mContext).load(imgSaveName).error(R.drawable.my_people).into(iv_my_data_icon);
                        updateInfoForImg();
                    }
                });
            }
    ...
    private void updateInfoForImg() {
        ...
        map.put("sign",GetSign.getSign(map));
        com.sk.lgdx.module.my.network.ApiRequest.updateUserImg(map, new MyCallBack<BaseObj>(mContext) {
            @Override
            public void onSuccess(BaseObj obj) {
                showMsg(obj.getMsg());
